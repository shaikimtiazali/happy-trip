...
const Home = () => {
    ...
    const submitHandler = e => {
        e.preventDefault();
        fetch("https://tw-frontenders.firebaseio.com/advFlightSearch.json").then(
            ...
            <div style={{ marginLeft: '300px', marginTop: '100px' }}>
                ...
                <Grid container>
                    ...
                    {/* {selectTrip?.toUpperCase() === "BOTH" && (
                        ...
                        <Grid className='two' item style={{ marginLeft: "100px" }}  >
                            <br></br>
                            <br></br>
                            <InputLabel id="demo-simple-select-helper-label" />Source City
                            <br></br>
                ...
                <div>
                    <br></br>
                    <br></br>
                    {data.length >= 1 ? <FlightDetails data={data} /> : null}
                </div>
